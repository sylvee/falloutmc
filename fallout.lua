...
local function fetchWordList(wordLength, amount)
	local url = "http://api.wordnik.com/v4/words.json/randomWords?hasDictionaryDef=true&limit=1&api_key=a2a73e7b926c924fad7001ca3111acd55af2ffabf50eb4ae5&maxLength="..tostring(wordLength)
	for i = 1, amount do
		http.request(url)
	end
	local wordList = {}
